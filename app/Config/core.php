 ...
 */
	Configure::write('Security.salt', 'Paris-Roubaix');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '4534486845245346457568768');
 ...
 * Config Log Server
 */
Configure::write('Config.log_server', 'http://plate.id');